...
## Grants of Use
* You may only access and use the Website for your personal and noncommercial use.
...
## User Submissions
* You are responsible for all the content you upload, submit, transmit, create, modify, download on this website.
...
## Copyright Claims
* Because we don't serve any content on the website itself, the only thing we can do is to forward your copyright claim to the corresponding subreddit on the Reddit Website.
* All notifies should be e-mailed to oldventura@protonmail.com.

## Contact Us
If you have any questions about these Terms and Conditions, You can contact us:

By email: oldventura@protonmail.com
